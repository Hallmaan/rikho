        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Kostzy"
              description="Kostzy is a application for rented acomodation"
              ghLink="https://play.google.com/store/apps/details?id=com.kostzy.kostzy_mobile&pcampaignid=web_share"
            />
          </Col>
